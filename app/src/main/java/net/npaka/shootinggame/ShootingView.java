...
public class ShootingView extends SurfaceView
    ...
    private long    offset[] = new long[30];    //fps
    ...
    public ShootingView(Activity activity) {
        ...
        //フォント
        segmentFont = Typeface.createFromAsset(getContext().getAssets(),"LED_BlackBack.ttf");
    ...
    public void drawScore(){
        ...
        g.drawText(num2str(score,6),
                120+g.getOriginX(), 10-(int)g.getFontMetrics().ascent);

        g.setTypeface(nikoFont);
        g.drawText("SCORE ",
                0+g.getOriginX(), 10-(int)g.getFontMetrics().ascent);
    }

    public void drawfps(){//long startTime, long endTime){
        /*
        ...
        */
        ...
        g.setTypeface(segmentFont);
        g.drawText(""+fps,
                360+g.getOriginX(), 10-(int)g.getFontMetrics().ascent);
        g.setTypeface(nikoFont);
        g.drawText("fps",
                290+g.getOriginX(), 10-(int)g.getFontMetrics().ascent);
    }
